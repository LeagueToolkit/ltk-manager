...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::get_runeforge_maps,
            commands::get_runeforge_mods,
            commands::get_runeforge_media,
            commands::get_download_image_data,
            commands::get_runeforge_releases,
            commands::get_divineskins_mods,
            commands::get_divineskins_media,
            commands::get_divineskins_releases,
            commands::get_divineskins_download_url,
